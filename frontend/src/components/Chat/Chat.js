...
import bg from "../../img/chatBackground.png";
      ...
      <div className="outerContainer">
        <div className="innerContainer">
          <div className="container">
            ...
            <UserProfile users={users} myname={name} socket={socket} />
              <div className="leftInnerContainer">
              </div>  
            </div> 
            <div className="messagesContainer" style={{backgroundImage: `linear-gradient(to bottom, #000080, #000080, #000080),url(${bg})`}}>
